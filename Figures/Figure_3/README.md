...
2. Download all files from the "Figures/Figure_3" folder of our [OSF project](https://osf.io/ytge5/). Place them in the 'Data' folder. The collection of CSV files contains the data to obtain the graphical results with the Jupyter Notebook ```Regional_Oncology_Exploration-Figure3.ipynb```.
