...
2- Download all files from OSF Figures/Figure_2 folder into the 'Data' folder. The collection of CSV files contains the data for obtain the graphical results with the Jupyter Notebook ```Entries_Distribution_and_Patient_Selection-Figure2.ipynb``` .
